...
export const metadata: Metadata = {
  title: "Před sportem – Sportovní výživa pro přípravu na výkon",
  description: "Produkty Enervit pro přípravu na sportovní výkon. Pre Sport tyčinky, Carbo Loading nápoje a další pro maximální naplnění glykogenových zásob.",
};

export default function PredSportemPage() {
  const info = categoryInfo.before;
  const prods = getProductsByCategory("before");
      ...
      <section className="bg-gradient-to-br from-emerald-600 to-emerald-800 py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-xs font-bold text-white/60 uppercase tracking-widest">BEFORE</span>
          </div>
