...
export const metadata: Metadata = {
  title: "Doplňky – Vitamíny a suplementy pro sportovce",
  description: "Doplňky stravy Enervit pro sportovce. Magic Cherry, kreatin, Hot Bar a další pro denní podporu výkonu a zdraví.",
};

export default function DoplnkyPage() {
  const info = categoryInfo.supplements;
  const prods = getProductsByCategory("supplements");

  return (
    <>
      <section className="bg-gradient-to-br from-amber-500 to-amber-700 py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-xs font-bold text-white/60 uppercase tracking-widest">SUPPLEMENTS</span>
          </div>
